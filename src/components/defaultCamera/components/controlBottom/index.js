...
const ControlBottom = (props) => {
  ...
  return (
      ...
      >
    ...
    </div><div className={isTriangleClicked ? "control-menu active" : "control-menu"}>
        ...
        <label for={"control-toggle"} id="show-control-menu">
          <div className={'control-btn'}>
            <div className={isTriangleClicked ? "triangle-container-down" : "triangle-container"}
            >
              <div className="control-triangle">
              </div>
              <div className="control-bold-line">
          ...
          <div className='control-btn circular'><i>2 </i></div>
